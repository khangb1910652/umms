  ...
  return router.get(
    ...
    async (
      ...
      try {
        ...
        for (const element of HdsdcItems) {
          const TraLoiHdsdcItems = await knex("BINHLUAN")
            .select("*")
            .join(
              "HUONGDANSUDUNG",
              "HUONGDANSUDUNG.MAHDSD",
          ...
          element.TraLoiBL = TraLoiHdsdcItems;
        }
